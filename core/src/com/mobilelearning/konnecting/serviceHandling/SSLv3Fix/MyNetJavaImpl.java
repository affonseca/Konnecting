package com.mobilelearning.konnecting.serviceHandling.SSLv3Fix;
...
public class MyNetJavaImpl {
    ...
    public MyNetJavaImpl() {
        ...
        try{
            ...
            SSLSocketFactory NoSSLv3Factory = new com.mobilelearning.konnecting.serviceHandling.SSLv3Fix.NoSSLv3SocketFactory(sslcontext.getSocketFactory());
