...
public class AnimationDrawable extends BaseDrawable
{
    ...
    public AnimationDrawableCallback callback;
    ...
    {
        if(callback != null &&
                !animation.isAnimationFinished(stateTime/animation.getFrameDuration()) &&
                animation.isAnimationFinished(stateTime/animation.getFrameDuration() + delta)){
            callback.onEnd();
    ...
    public void setCallback(AnimationDrawableCallback callback){
